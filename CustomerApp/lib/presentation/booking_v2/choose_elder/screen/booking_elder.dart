        ...
        child: ElevatedButton(
          onPressed: () {
            if (chosenElder == null) {
              ...
              elderBookingBloc.eventController.sink.add(
                  ClickSubmitElderEvent(context: context, elder: chosenElder!));
            }
          },
          style: ElevatedButton.styleFrom(
            backgroundColor:
                chosenElder == null ? Colors.grey : ColorConstant.primaryColor,
            padding: EdgeInsets.only(
                      ...
                      elderBookingBloc.list.isEmpty
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) => GestureDetector(
                                ...
                                child: elderItem(context,
                                    elderBookingBloc.list[index], chosenElder),
                              ),
