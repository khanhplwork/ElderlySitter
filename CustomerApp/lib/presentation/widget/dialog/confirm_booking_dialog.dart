...
Future<void> showConfirmBookingDialog(BuildContext context, String content,
    BookingBloc bookingBloc, BookingDataModel booking) async {
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          bookingBloc.eventController.sink.add(
                              CreateBookingEvent(
                                  booking: booking, context: context));
                        },
                      ),
                    ),
                  ],
