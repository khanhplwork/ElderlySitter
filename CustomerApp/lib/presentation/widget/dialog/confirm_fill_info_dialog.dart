...
Future<void> showConfirmFillInfoDialog(BuildContext context) async {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Thông tin của người dùng chưa đầy đủ",
                  textAlign: TextAlign.center,
                  style: GoogleFonts.roboto(
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const PersonalDetailScreen(),));
                        },
                      ),
                    ),
                  ],
