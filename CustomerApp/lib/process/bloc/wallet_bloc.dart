import 'dart:async';
import 'dart:convert';
import 'package:elscus/presentation/wallet_screen/widgets/choose_payment_method_dialog.dart';
...
class WalletBloc{
  ...
  WalletBloc(){
    eventController.stream.listen((event) {
      if(event is ChoosePaymentMethodToDepositMoneyIntoWalletEvent){
        showChoosePaymentMethodDialog(event.context);
      }
