...
import 'package:elscus/process/state/cancel_booking_state.dart';
...
class CancelBookingBloc{
    ...
    eventController.stream.listen((event) {
      ...
      if (event is ChooseInfoBookingContentCancelBookingEvent) {
        ...
        stateController.sink.add(
            ChooseInfoBookingCancelBookingState(infoBookingType: event.infoBookingType));
      }
  ...
  Future<void> cancelBooking(
    ...
    try {
      var url = Uri.parse(
          "https://monkfish-app-ocxq6.ondigitalocean.app/api/v1/booking/mobile/customer-cancel-booking");
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => const SuccessScreen(
                  content: "Hủy lịch thành công.\nHệ thống sẽ xử lý yêu cầu của bạn trong thời gian sớm nhất",
